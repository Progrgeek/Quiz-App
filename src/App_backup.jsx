                  ...
                  <BrowserRouter>
                    <div className=" sm:min-h-screen  sm:bg-gradient-to-br from-blue-500 via-blue-300 to-green-300">
                      ...
                      <Routes>
                        ...
                        <Route path="/user-behavior" element={<UserBehaviorAnalysis />} />
                        <Route path="/ab-testing" element={<ABTestingFramework />} />
                        <Route path="/phase6-integration-test" element={<Phase6IntegrationTest />} />
                        <Route path="/phase6-test" element={<Phase6IntegrationTest />} />
                        <Route path="/enterprise-architecture" element={<EnterpriseArchitectureDashboard />} />
                        <Route path="/internationalization" element={<InternationalizationDashboard />} />
